#include "com_fuxi_javaagent_contentobjects_jnotify_macosx_JNotify_macosx.h"
  ...
  (JNIEnv *env, jclass clazz, jstring jpath)
{
  ...
  if (node->stream == NULL)
  {
    (*env)->ThrowNew(env, (*env)->FindClass(env, "com/fuxi/javaagent/contentobjects/jnotify/macosx/JNotifyException_macosx"), "Could not create stream");
    free(node);
    (*env)->DeleteGlobalRef(env, jpath);
    goto nonode;
  }
  ...
  {
    (*env)->ThrowNew(env, (*env)->FindClass(env, "com/fuxi/javaagent/contentobjects/jnotify/macosx/JNotifyException_macosx"), "Could not start stream");
